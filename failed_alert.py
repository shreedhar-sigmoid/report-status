...
def send_failed_alert(all_data_list, previous_day_epoch, today_epoch, yesterday_date):
    ...
    failed_message["Subject"] = "[ALERT] Failed Reports [{yesterday_date}]".format(
    ...
    for reports_list in all_data_list:
        if reports_list[2] != []:  # Handling exception for monthly report
    ...
    html = """\
        ...
        failed_row=failed_row, yesterday_date=yesterday_date
    )
