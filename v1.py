            ...
            if reports_list[2] != []:
                for report in reports_list[2]:
                    ...
                    if estimated_reports_number != count_of_all_states:
                        ...
                        xlsx_header_list = ["Estimated_reports IDs", "Total_sent_reports IDs", "Total_pending_reports IDs", "Total_inprogess_reports IDs", "Total_No_date_reports IDs", "Total_failed_reports IDs"]
